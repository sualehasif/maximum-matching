...
#ifndef MAXIMUM_MATCHING_CHERRY_TREE_H
#define MAXIMUM_MATCHING_CHERRY_TREE_H
...
namespace maxmatching::norm {
    ...
    void MCherryTree<Label>::rotate(MVertex<Label>* newRoot) {
        ...
        auto* l = new List<HalfEdge<Label>>();
    ...
    * the children of the new nodes. */
    ...
    void MCherryTree<Label>::makeBlossom(HalfEdge<Label> * e) {
        ...
        * of which the other is in the corolla */
        ...
        while (!ss.empty() && !ts.empty() && ss.back() == ts.back()) {
            s = ss.back();
            ss.pop_back();
            ts.pop_back();
        }
    ...
    void MCherryTree<Label>::updateLevelBelow(MVertex<Label> * v) {
        auto* remainingVertices = new List<MVertex<Label>>();
    ...
    List<MVertex<Label>>* MCherryTree<Label>::getVertices() {
        auto* ret = new List<MVertex<Label>>();
...
#endif //MAXIMUM_MATCHING_CHERRY_TREE_H
