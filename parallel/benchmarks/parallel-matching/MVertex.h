...
#ifndef MAXIMUM_MATCHING_MVERTEX_H
#define MAXIMUM_MATCHING_MVERTEX_H
...
namespace maxmatching {
    ...
    public:
        ...
        inline virtual ~BaseVertex() = default;
...
namespace maxmatching::norm {
    ...
    private:
         ...
         * This is not necessarily the representant in the disjoint-set data structure!
    ...
    public:
        ...
        MVertex<Label>* getNeighbor(unsigned int i);
...
#endif //MAXIMUM_MATCHING_MVERTEX_H
